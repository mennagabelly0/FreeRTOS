...
#define SPI_NSS_Hardware_Master_SS_Output_Enable				(1<<2)
#define SPI_NSS_Hardware_Master_SS_Output_Disable				~(1<<2)
 ...
 */
#define SPI_NSS_Software_Internal_Reset							((1<<9) | (uint16_t)(0))
